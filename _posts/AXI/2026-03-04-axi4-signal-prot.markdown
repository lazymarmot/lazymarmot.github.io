...
CPU가 자동으로 이 비트를 바꿔서 내보내게 됨(개발자가 매번 설정하지 않음)
    ...
    AXI 주소 채널:
        ...
        WPROT[1]= (Secure/Non-secure 상태에 따라)
...
<span style="color:red">CPU 내부 상태</span>
...
```
<br>
<span style="color:red">AXI Write Address Channel에서 나가는 신호</span>
...
```
<br>
<span style="color:red">Interconnect에서 처리</span>
...
```
<br>
<span style="color:red">Write Data Channel은 별도지만, 속성은 이미 확정</span>
...
<span style="color:red">Secure DMA 입장</span>
