...
<span style="color:yellow"> “master - interconnect, interconnect - slave, master - slave 누구랑 붙든지 AXI Interface는 신호 모양은 똑같음”</span>
